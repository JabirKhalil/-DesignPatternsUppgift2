...
namespace Design_Patterns_Assignment
{
    internal class Strategy
    {
        internal static void Run()
        {
            ...
            //var messageZ = new Design_Patterns_Assignment.Strategy.A();
            //var smssender = new Design_Patterns_Assignment.Strategy.BSMS();
            //messageZ.messageSender = smssender;
            //messageZ.sendMessage("test");
